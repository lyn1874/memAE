...
class VideoDataset(Dataset):
    def __init__(self, idx_root, frame_root, use_cuda=False, transform=None):
        ...
        self.idx_num = len(self.idx_path_list)  # this contains all the frames, in the avenue dataset, it will be 15...
    ...
    def __getitem__(self, item):
        ...
        idx_data = sio.loadmat(idx_path)    # idx data  # how come it's a mat?
